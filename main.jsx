...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // React Mount for Professional Journey Horizontal Scroll
    const journeyRootElement = document.getElementById('journey-root');
    if (journeyRootElement) {
        const root = createRoot(journeyRootElement);
        root.render(<HorizontalScrollCarousel />);
    }
    ...
    // ============================================
    // STACKING CARDS â€” Scroll-Driven Animation
    // ============================================
    initStackingCards();
});
